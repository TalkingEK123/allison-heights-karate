...
export const EVENTS: Event[] = [
    ...
    { id: "kns-kata-2025-09-05", title: "KNS Kata Workshop (Claudia Laos‑Loo)", type: "Seminar", start: "2025-09-05", end: "2025-09-07", time: "All day", location: "Halifax, NS", url:"https://karatens.org/events/kata-clinic-claudia-laos-loo/" },
    ...
    { id: "knb-closed-2026-03-08", title: "KNB Closed Development #1 — Weight Check & Senior Team Debrief", type: "Training", start: "2026-03-08", time: "Daytime", location: "Saint John, NB" },
    { id: "kns-gp-2026-03-21", title: "KNS Grand Prix", type: "Competition", start: "2026-03-21", time: "All day", location: "Enfield, NS" },
    { id: "knb-closed-2026-03-22", title: "KNB Closed Development #2", type: "Training", start: "2026-03-22", time: "Daytime", location: "Saint John, NB" },

    { id: "kns-kumite-hana-2026-04-12", title: "KNS Kumite Clinic (Hana Furumoto‑Deshais) — Tentative", type: "Seminar", start: "2026-04-12", time: "All day", location: "Halifax, NS" },
    { id: "knb-closed-2026-04-19", title: "KNB Closed Development #3", type: "Training", start: "2026-04-19", time: "Daytime", location: "Saint John, NB" },
    { id: "knb-closed-2026-04-26", title: "KNB Closed Development #4 — Weight Check", type: "Training", start: "2026-04-26", time: "Daytime", location: "Saint John, NB" },

    { id: "knb-closed-2026-05-03", title: "KNB Closed Development #5 — Weight Check", type: "Training", start: "2026-05-03", time: "Daytime", location: "Saint John, NB" },
    { id: "arrive-nats-2026-05-10", title: "Arrive to Nationals", type: "Special", start: "2026-05-10", time: "Travel day", location: "Edmonton, AB" },
    { id: "kc-junior-nats-2026-05-11", title: "2026 Junior Karate Canada National Championships", type: "Competition", start: "2026-05-11", end: "2026-05-17", time: "All day", location: "Edmonton, AB" },

    { id: "knb-fitness-2026-05-30", title: "KNB Fitness Testing — CSIA High Performance Gym (Tent.)", type: "Testing", start: "2026-05-30", time: "All day", location: "Fredericton, NB" },

    { id: "knb-closed-2026-06-07", title: "KNB Closed Development #5 — Debrief", type: "Training", start: "2026-06-07", time: "Daytime", location: "Saint John, NB" },
    { id: "east-coast-games-2026-06-20", title: "East Coast Games", type: "Competition", start: "2026-06-20", end: "2026-06-21", time: "All day", location: "Saint John, NB" },

    { id: "knb-clinic-2026-07-05", title: "KNB Clinic", type: "Training", start: "2026-07-05", time: "Daytime", location: "Saint John, NB" },
    { id: "knb-summer-camp-2026-07-24", title: "KNB Summer Camp", type: "Training", start: "2026-07-24", end: "2026-07-26", time: "All day", location: "Saint John, NB" },

    { id: "knb-open-2026-08-16", title: "KNB Open Development Training #6", type: "Training", start: "2026-08-16", time: "Daytime", location: "Saint John, NB" },
    { id: "jr-pan-am-2026-08-23", title: "Junior Pan American Championships", type: "Competition", start: "2026-08-23", end: "2026-08-29", time: "All day", location: "Lima, Peru" },
];
